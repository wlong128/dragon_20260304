...
try{
    ...
    // 設定 SQL insert指令
    $sql = "INSERT INTO product (product_name, product_content, product_price, product_type_id, product_state, product_img) VALUES ('$product_name', '$product_content', '$product_price', '$product_type_id', '$product_state', '$newname')";
    // echo $sql;
    // 執行 SQL 查詢指令 
